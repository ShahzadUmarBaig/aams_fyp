...
class TableComplexExample extends StatefulWidget {
  ...
  TableComplexExample(this.selectDate,
          ...
          ValueListenableBuilder<DateTime>(
            ...
            builder: (context, value, _) {
              return _CalendarHeader(
                ...
                lastYear: () {
                  setState(() {
                    if (DateTime(1950).year + 1 != value.year && DateTime(1950).year != value.year) {
                      DateTime current = value;
                      setState(() => _focusedDay.value = DateTime(current.year, current.month - 12, current.day));
                    } else {
                ...
                nextYear: () {
                  setState(() {
                    if (DateTime.now().year - 1 != value.year && DateTime.now().year != value.year) {
                      DateTime current = value;
                      setState(() => _focusedDay.value = DateTime(current.year, current.month + 12, current.day));
                    } else {
                      setState(() => _focusedDay.value = DateTime.now());
            ...
            child: TableCalendar<Event>(
              ...
              calendarStyle: CalendarStyle(
                  ...
                  selectedTextStyle: const TextStyle(
                      fontSize: 16, fontWeight: FontWeight.bold, color: Colors.blue, fontFamily: 'Poppins'),
                  weekendTextStyle:
                      TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black, fontFamily: 'Poppins'),
                  selectedDecoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color: Colors.grey.shade200,
                  ),
                  disabledTextStyle: const TextStyle(
                      fontSize: 16, fontWeight: FontWeight.bold, color: Colors.grey, fontFamily: 'Poppins'),
                  outsideTextStyle: const TextStyle(
                      fontSize: 16, fontWeight: FontWeight.bold, color: Colors.grey, fontFamily: 'Poppins'),
                  defaultTextStyle: const TextStyle(
                      fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black, fontFamily: 'Poppins'),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        widget.selectTime!(_hours.text + ':' + _minutes.text + (isPM ? ' PM' : ' AM'));
                      },
                      child: Container(
                          ...
                          child: const Text(
                            'CONFIRM',
                            style: TextStyle(
                                fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white, fontFamily: 'Poppins'),
                          )),
                    ),
                  ],
                ),
      ...
      child: Row(
        children: [
          ...
          Text(
            '$month, $year',
            style:
                const TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.w600, fontFamily: 'Poppins'),
          ),
          Spacer(),
